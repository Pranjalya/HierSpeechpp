...
if __name__ == "__main__":
    ...
    duration = syn.inference(
        text="Testing the voice.", prompt="example/reference_1.wav", duration_only=True
    )
    print(f"Duration : {duration} seconds")

    # Return Sample Rate and Audio in Numpy Array
    sr, waveform = syn.synthesize(
        text="Testing the voice.", prompt="example/reference_1.wav"
    )
    ...
    path = syn.inference(
        text="Testing the voice.", prompt="example/reference_1.wav", vec2wav_prompt="example/reference_3.wav"
    )
    print(f"Saved in {path}")